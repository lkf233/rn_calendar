...
const WeekView = () => {
  ...
  const days = React.useMemo(() => getWeekDays(current), [current]);
  ...
  const prevWeek = () => {
    setCurrent((prev) => new Date(prev.getFullYear(), prev.getMonth(), prev.getDate() - 7));
  };
  const nextWeek = () => {
    setCurrent((prev) => new Date(prev.getFullYear(), prev.getMonth(), prev.getDate() + 7));
  };
    ...
    <View style={styles.wrapper}>
      <View style={styles.headerBar}>
        <Pressable onPress={prevWeek} style={styles.navBtn}>
          <Text style={styles.navText}>上一周</Text>
        </Pressable>
        ...
        <Pressable onPress={nextWeek} style={styles.navBtn}>
          <Text style={styles.navText}>下一周</Text>
        </Pressable>
      </View>
...
const styles = StyleSheet.create({
  ...
  cell: { width: '14.2857%', height: 72, borderColor: '#eee', borderWidth: 1, padding: 4, position: 'relative', alignItems: 'center', justifyContent: 'center' },
